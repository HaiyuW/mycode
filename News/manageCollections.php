...
function showContent() {
    ...
    while($stmt->fetch()) {
        echo sprintf('
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delModal_%s">
                        delete
                    </button>
                    </div>
                </div>
            ...
            <div class="modal fade" id="delModal_%s">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">! THIS WILL DELETE ONE OF YOUR COLLECTION, ARE YOU SURE?</h4>
        ...
        ',$news_id, htmlentities($_SERVER['PHP_SELF']), $_SESSION['token'], $news_id);
    }
    $stmt->close();
}

// query the database and delete collections
