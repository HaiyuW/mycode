#ifndef ENCRYPT_TOOLS_H
#define ENCRYPT_TOOLS_H
#include<string>
#include<iostream>
#include<stdio.h>
struct QuoRemain{
...
class encrypt_tools
{
    public:
        ...
        const int col[4][4] = {{2,3,1,1},{1,2,3,1},{1,1,2,3},{3,1,1,2}};
        const int concol[4][4] = {{0x0e,0x0b,0x0d,0x09},{0x09,0x0e,0x0b,0x0d},{0x0d,0x09,0x0e,0x0b},{0x0b,0x0d,0x09,0x0e}};
        int key[4][44] = {0};
        int rcon[40] = {0x01,0,0,0,0x02,0,0,0,0x04,0,0,0,0x08,0,0,0,
        ...
        void init_key();
        void expansion_key();
        void printm(std::string m_path);
        //void de_printm(std::string m_path);
        ...
        void encrypt(std::string m_path,std::string key_path);
        //void decrypt(std::string m_path,std::string key_path);
        void encrypt_mblock();
        //void decrypt_mblock();
    private:
};

#endif // ENCRYPT_TOOLS_H
